// iNaturalist integración — INSECTOS (iconic_taxa=Insecta)
const API = "https://api.inaturalist.org/v1";
const state = { q: "", page: 1, per: 60, total: 0, placeId: null, iconic: "Insecta" };
...
function cardHTML(o){
  ...
  return `
    <article class="card">
      ...
      <div class="body">
        <div class="name">${sci}${com ? ` — <span style="font-weight:600;color:#f8e0be">${com}</span>`:""}</div>
        <div class="meta">
