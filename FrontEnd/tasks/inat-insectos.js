// iNaturalist — Insectos (Insecta) + favoritos
...
function openModal(o){
  ...
  modalContent.innerHTML = `
    ...
    <div class="modal-actions">
      ...
      <input id="fav-new-name" placeholder="Nueva lista…" style="flex:1;min-width:160px;padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,.25);background:#0d1224;color:#e8eefb">
...
grid.addEventListener("click",(e)=>{
  ...
  if (heart) {
    ...
    if (isFavorite(id)) removeFromList("General", id);
    else addToList("General", makeFavItem(o, iconic));
    refreshHearts();
    return;
  }
